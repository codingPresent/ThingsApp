...
//  ThingsApp
//
//  Created by Naveen Kumawat on 30/07/22.
//
...
struct AnimatedCheckmarkView: View {
    ...
    var toColor: Color = Color("ThingButtonText")
    var strokeStyle: StrokeStyle = .init(lineWidth: 2.4, lineCap: .round, lineJoin: .round)
